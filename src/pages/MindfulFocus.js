...
class MindfulFocus extends React.Component{
            ...
            <div className="body">
                ...
                {!this.state.isMobile && 
                    <motion.nav className="navigation">
                        <img style={{marginTop: "25%", width: "100%"}} alt="mindful logo" src={require('../images/mindfulCirc.png')}/>
                        <motion.p animate={{opacity: [0, 1]}} id="sidebar-title">Mindful</motion.p>
                ...
                {this.state.isMobile && 
                    <motion.nav className="mobile-nav">
                        <img style={{marginTop: "5%", width: "40%"}} alt="mindful logo" src={require('../images/mindfulCirc.png')}/>
                        <motion.p animate={{opacity: [0, 1]}} className={"sidebar-title-mobile"}>Mindful</motion.p>
                    </motion.nav>
                }
                </div>
                <div className={!this.state.isMobile ? "main" : "mobileMain"}>
                    {!this.state.isMobile && <img id="bannerImg" alt="dino with speech bubble of code" src={require("../images/useIt.png")}/>}
                    <section id="overview" style={{paddingTop: this.state.isMobile ? "25vh" : 0}} className={!this.state.isMobile ? "sectionContainer" : "mobileContainer"}>
                        ...
                        <div id="overview-container">
                            <p className={!this.state.isMobile ? "sectionP" : "mobileP"} style={{width: "100%"}}>
                                {!this.state.isMobile && <img style={{width: "35%", float: "right", marginLeft: "1.5%", borderRadius: "5%", overflow: 'hidden'}} alt="phone on a background with notepad" src={require('../images/overview.png')}/>}
                            ...
                            <p style={{fontWeight: 500, color: "#3d73d6", fontSize: !this.state.isMobile ? "1.25vw" : "7vw", textAlign: 'left'}}>
                    ...
                    <section id="usecase" className={!this.state.isMobile ? "sectionContainer" : "mobileContainer"}>
                        ...
                        <div id="overview-container">
                            ...
                            <p className={!this.state.isMobile ? "sectionP" : "mobileP"} style={{width: "100%"}}>
                                {!this.state.isMobile && <img style={{width: "35%", float: "right", marginLeft: "1.5%", borderRadius: "5%", overflow: 'hidden'}} alt="Dinosaur at a computer" src={require('../images/useDino.png')}/>}
                    ...
                    <section id="breakdown" className={!this.state.isMobile ? "sectionContainer" : "mobileContainer"}>
                        ...
                        <div id="overview-container" style={{paddingBottom: "15%"}}>
                            <h3 className={this.state.isMobile ? "mobileH3" : "sectionSubHeader"}>How was Mindful created?</h3>
                            <p className={!this.state.isMobile ? "sectionP" : "mobileP"} style={{width: "100%"}}>
                            ...
                            <h3 className={this.state.isMobile ? "mobileH3" : "sectionSubHeader"}>Let's look at a few features.</h3>
                            <Carousel mobile={this.state.isMobile}/>
                        </div>
                    </section>
                </div>
            </div>
