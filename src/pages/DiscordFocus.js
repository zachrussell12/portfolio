...
class DiscordFocus extends React.Component{
    ...
    render(){
        return(
            <div className="body">
                <div className={!this.state.isMobile ? "sidebar" : "mobilebar"}>
                {!this.state.isMobile && 
                    <motion.nav className="sidebar-main" style={{paddingTop: "25%"}}>
                        <img style={{width: "50%", borderRadius: "50%", marginTop: 0, aspectRatio: 1, objectFit: "cover"}} alt="mindful logo" src={'https://support.discord.com/hc/article_attachments/1500015317842/Rebrand_Blog__1_.png'}/>
                        <motion.p animate={{opacity: [0, 1]}} className="sidebar-title">Project Management Discord Bot</motion.p>
                        <div>
                            <motion.a className="links" href="#overview" animate={{opacity: [0, 1], transition: {delay: 0.2}}}>
                                <motion.p whileHover={{color: ['hsl(4, 0, 100)', 'hsl(43, 100, 50)'], transition: {duration: 0.4}  }}>Overview</motion.p>
                            </motion.a>
                            <motion.a className="links" href="#usecase" animate={{opacity: [0, 1], transition: {delay: 0.4}}}>
                                <motion.p  whileHover={{color: ['hsl(4, 0, 100)', 'hsl(43, 100, 50)'], transition: {duration: 0.4}  }}>Use Case</motion.p>
                            </motion.a>
                            <motion.a className="links" href="#breakdown" animate={{opacity: [0, 1], transition: {delay: 0.6}}}>
                                <motion.p  whileHover={{color: ['hsl(4, 0, 100)', 'hsl(43, 100, 50)'], transition: {duration: 0.4}  }}>Technical Breakdown</motion.p>
                            </motion.a>
                            <motion.a className="links" onClick={()=>{document.location.href = "https://github.com/zachrussell12/Project-Coordinator-Bot";}} animate={{opacity: [0, 1], transition: {delay: 0.6}}}>
                                <motion.p  whileHover={{color: ['hsl(4, 0, 100)', 'hsl(43, 100, 50)'], transition: {duration: 0.4}  }}><SiGithub/></motion.p>
                            </motion.a>
                        </div>
                    </motion.nav>
                }
                {this.state.isMobile && 
                    <motion.nav className="mobile-nav" style={{paddingTop: "5%"}}>
                        <img style={{width: "20%", borderRadius: "50%", marginTop: 0, aspectRatio: 1, objectFit: "cover"}} alt="mindful logo" src={'https://support.discord.com/hc/article_attachments/1500015317842/Rebrand_Blog__1_.png'}/>
                        <motion.p animate={{opacity: [0, 1]}} className={"sidebar-title-mobile"}>Project Management Discord Bot</motion.p>
                    </motion.nav>
                }
                </div>
                <div className={!this.state.isMobile ? "main" : "mobileMain"}>
                    {!this.state.isMobile && <img id="bannerImg" alt="dino with speech bubble of code" src={require("../images/discordBanner.png")}/>}
                    <section id="overview" style={{paddingTop: this.state.isMobile ? "25vh" : 0}} className={!this.state.isMobile ? "sectionContainer" : "mobileContainer"}>
                        ...
                        <div id="overview-container">
                            <p className={!this.state.isMobile ? "sectionP" : "mobileP"} style={{width: "100%"}}>
                                ...
                                {this.state.isMobile && <img style={{width: "100%", marginBlock: "5%", borderRadius: "5%", overflow: 'hidden'}} alt="phone on a background with notepad" src={require('../images/projInfo.png')}/>}
                            ...
                            <h3 className={this.state.isMobile ? "mobileH3" : "sectionSubHeader"}>What is the main functionality?</h3>
                    ...
                    <section id="usecase" className={!this.state.isMobile ? "sectionContainer" : "mobileContainer"}>
                        ...
                        <div id="overview-container">
                            <h3 className={this.state.isMobile ? "mobileH3" : "sectionSubHeader"}>Who is the target audience?</h3>
                            <p className={!this.state.isMobile ? "sectionP" : "mobileP"} style={{width: "100%"}}>
                            ...
                            <h3 className={this.state.isMobile ? "mobileH3" : "sectionSubHeader"}>What features make it useful to the target audience?</h3>
                            <p className={!this.state.isMobile ? "sectionP" : "mobileP"}>
                                ...
                                {this.state.isMobile && <video style={{width: "100%", float: "right", marginLeft: "1.5%", borderRadius: "5%", overflow: 'hidden', objectFit: "cover",}} autoPlay="false" loop="true" src={require('../videos/createNewExample.mp4')}/>}
                            </p>
                            <p className={!this.state.isMobile ? "sectionP" : "mobileP"}>
                    ...
                    <section id="breakdown" className={!this.state.isMobile ? "sectionContainer" : "mobileContainer"}>
                        ...
                        <div id="overview-container" style={{paddingBottom: "5%"}}>
                            <h3 className={this.state.isMobile ? "mobileH3" : "sectionSubHeader"}>Features of the Project Coordinator Bot</h3>
                            <p className={!this.state.isMobile ? "sectionP" : "mobileP"} style={{width: "100%"}}>
                            ...
                            <div className={!this.state.isMobile ? 'feature-container' : 'feature-container-mobile'}>
                                {/*Create New Command*/}
                                <div className={!this.state.isMobile ? 'feature-cell' : 'feature-cell-mobile'}>
                                    <h2 className={!this.state.isMobile ? 'feature-h2' : 'feature-h2-mobile'}>
                                        The <span style={{color: '#4139b5'}}>!createnew</span> Command
                                    </h2>
                                ...
                                <div className={!this.state.isMobile ? 'feature-cell' : 'feature-cell-mobile'}>
                                    <h2 className={!this.state.isMobile ? 'feature-h2' : 'feature-h2-mobile'}>
                                        The <span style={{color: '#4139b5'}}>!display</span> Command
                                    </h2>
                                    <p className={!this.state.isMobile ? 'feature-p' : 'feature-p-mobile'}>
                                ...
                                <div className={!this.state.isMobile ? 'feature-cell' : 'feature-cell-mobile'}>
                                    <h2 className={!this.state.isMobile ? 'feature-h2' : 'feature-h2-mobile'}>
                                        The <span style={{color: '#4139b5'}}>!update</span> Command
                                    </h2>
                                    <p className={!this.state.isMobile ? 'feature-p' : 'feature-p-mobile'}>
                                ...
                                <div className={!this.state.isMobile ? 'feature-cell' : 'feature-cell-mobile'}>
                                    <h2 className={!this.state.isMobile ? 'feature-h2' : 'feature-h2-mobile'}>
                                        The <span style={{color: '#4139b5'}}>!delete</span> Command
                                    </h2>
                                    <p className={!this.state.isMobile ? 'feature-p' : 'feature-p-mobile'}>
                                ...
                                <div className={!this.state.isMobile ? 'feature-cell' : 'feature-cell-mobile'}>
                                    <h2 className={!this.state.isMobile ? 'feature-h2' : 'feature-h2-mobile'}>
                                        The <span style={{color: '#4139b5'}}>!note</span> Command
                                    </h2>
                                    <p className={!this.state.isMobile ? 'feature-p' : 'feature-p-mobile'}>
                                ...
                                <div className={!this.state.isMobile ? 'feature-cell' : 'feature-cell-mobile'}>
                                    <h2 className={!this.state.isMobile ? 'feature-h2' : 'feature-h2-mobile'}>
                                        The <span style={{color: '#4139b5'}}>!printnotes</span> Command
                                    </h2>
                                    <p className={!this.state.isMobile ? 'feature-p' : 'feature-p-mobile'}>
                                ...
                                <div className={!this.state.isMobile ? 'feature-cell' : 'feature-cell-mobile'}>
                                    <h2 className={!this.state.isMobile ? 'feature-h2' : 'feature-h2-mobile'}>
                                        The <span style={{color: '#4139b5'}}>!progress</span> Command
                                    </h2>
                                    <p className={!this.state.isMobile ? 'feature-p' : 'feature-p-mobile'}>
                                ...
                                <div className={!this.state.isMobile ? 'feature-cell' : 'feature-cell-mobile'}>
                                    <h2 className={!this.state.isMobile ? 'feature-h2' : 'feature-h2-mobile'}>
                                        The <span style={{color: '#4139b5'}}>!remind</span> Command
                                    </h2>
                                    <p className={!this.state.isMobile ? 'feature-p' : 'feature-p-mobile'}>
